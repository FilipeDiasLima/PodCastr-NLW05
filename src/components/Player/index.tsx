...
export function Player() {
  ...
  const {clearPlayerState, toggleShuffle, isShuffling, toggleLoop, isLooping, hasNext, hasPrevious ,episodeList, currentEpisodeIndex, setPlayingState, isPlaying, togglePlay, playNext, playPrevious} = useContext(PlayerContext);
